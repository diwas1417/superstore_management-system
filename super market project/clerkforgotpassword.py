...
class ClerkForgotPasswordPage:
    def __init__(self, root):
        ...
        label_clerk_id = Label(forgot_password_frame, text="Clerk Id:", font=("times new roman", 15, "bold"),
                               bg="white", fg="black")
        ...
        label_clerk_username = Label(forgot_password_frame, text="Clerk UserName:",
        ...
        label_clerk_phone = Label(forgot_password_frame, text="Clerk Phone:", font=("times new roman", 15, "bold"),
                                  bg="white", fg="black")
        ...
        label_clerk_email = Label(forgot_password_frame, text="Clerk E-mail:", font=("times new roman", 15, "bold"),
                                  bg="white", fg="black")
        ...
        label_clerk_new_password = Label(forgot_password_frame, text="New Password:",
                                         font=("times new roman", 15, "bold"), bg="white", fg="black")
        label_clerk_new_password.place(x=50, y=250)
        self.entry_clerk_new_password = Entry(forgot_password_frame, show='*', font=("times new roman", 15),
                                              bg="lightgray", width=25)
        self.entry_clerk_new_password.place(x=210, y=250)

        reset_btn = Button(forgot_password_frame, command=self.clerkForgotPassword, text="Reset Password", bg="white",
                           fg="green", font=("times new roman", 15, "bold"), width=15, )
