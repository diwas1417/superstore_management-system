...
class ClerkLogin:
    def __init__(self, root1):
        ...
        self.back_btn = Button(root1, text="<", command=self.back, bg="#021e2f", fg="green",
                               font=("times new roman", 15, "bold"), width=2, )
        self.back_btn.place(x=0, y=0)

        self.label_title = Label(self.clerk_login_frame, text=" Clerk Login", font=("times new roman", 30, "bold"),
                                 bg="white", fg="green")
        self.label_title.place(x=100, y=10)

        # entry field
        self.label_user_name = Label(self.clerk_login_frame, text="User Name", font=("times new roman", 15, "bold"),
                                     bg="white", fg="gray")
        ...
        self.label_password = Label(self.clerk_login_frame, text="Password", font=("times new roman", 15, "bold"),
                                    bg="white", fg="gray")
        self.label_password.place(x=120, y=150)
        self.entry_clerk_password = Entry(self.clerk_login_frame, show='*', font=("times new roman", 20),
                                          bg="lightgray", )
        self.entry_clerk_password.place(x=120, y=180)

        self.register_btn = Button(self.clerk_login_frame, text="Register", command=self.register, bg="white",
                                   fg="blue", font=("times new roman", 15), bd=0, )
        ...
        self.forgot_password_btn = Button(self.clerk_login_frame, text="Forgot Password", command=self.forget_password,
                                          bg="white", fg="red", font=("times new roman", 15), bd=0, )
        self.forgot_password_btn.place(x=160, y=240)

        self.login_btn = Button(self.clerk_login_frame, command=self.clerkLogin, text="Login", bg="white", fg="green",
                                font=("times new roman", 15, "bold"), width=7, )
