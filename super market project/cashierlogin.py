...
class CashierLogin:
    def __init__(self, root):
        ...
        self.title = Label(self.cashier_login_frame, text=" Cashier Login", font=("times new roman", 30, "bold"),
                           bg="white", fg="green")
        self.title.place(x=100, y=30)

        # entry field
        self.label_user_name = Label(self.cashier_login_frame, text="User Name", font=("times new roman", 15, "bold"),
                                     bg="white", fg="gray")
        ...
        self.label_password = Label(self.cashier_login_frame, text="Password", font=("times new roman", 15, "bold"),
                                    bg="white", fg="gray")
        self.label_password.place(x=120, y=150)
        self.entry_cashier_password = Entry(self.cashier_login_frame, show='*', font=("times new roman", 20),
                                            bg="lightgray", )
        self.entry_cashier_password.place(x=120, y=180)

        self.cashier_forgot_password_btn = Button(self.cashier_login_frame, command=self.cashierForgetPassword,
                                                  text="Forgot Password", bg="white", fg="red",
                                                  font=("times new roman", 15), bd=0, )
        self.cashier_forgot_password_btn.place(x=120, y=240)

        self.cashier_login_btn = Button(self.cashier_login_frame, command=self.cashierLogin, text="Login", bg="white",
                                        fg="green", font=("times new roman", 15, "bold"), width=7, )
