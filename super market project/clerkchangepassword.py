...
class ClerkChangePassword:
    def __init__(self, root):
        ...
        self.label_heading = Label(self.register_frame, text="You Are Clerk And Change Your Password",
                                   font=("times new roman", 20, "bold"), bg="grey", fg="black")
        self.label_heading.place(x=10, y=10)

        self.label_clerk_id = Label(self.register_frame, text="Enter Your Id:", font=("times new roman", 15, "bold"),
                                    bg="white", fg="black")
    ...
    def view(self, *args, **kwargs):
        ...
        for r in self.result:
            ...
            if self.r1 == int(self.entry_clerk_id.get()):
                self.label_clerk_current_password = Label(self.register_frame, text="Current Password",
                                                          font=("times new roman", 15, "bold"), bg="white", fg="black")
                self.label_clerk_current_password.place(x=50, y=100)
                self.entry_clerk_current_password = Entry(self.register_frame, show='*', font=("times new roman", 15),
                                                          bg="lightgray", width=25)
                self.entry_clerk_current_password.place(x=230, y=100)

                self.label_clerk_new_password = Label(self.register_frame, text="Your New Password",
                                                      font=("times new roman", 15, "bold"), bg="white", fg="black")
                self.label_clerk_new_password.place(x=50, y=150)
                self.entry_clerk_new_password = Entry(self.register_frame, show='*', font=("times new roman", 15),
                                                      bg="lightgray", width=25)
                self.entry_clerk_new_password.place(x=230, y=150)

                self.label_clerk_re_new_password = Label(self.register_frame, text="Re New Password",
                                                         font=("times new roman", 15, "bold"), bg="white", fg="black")
                self.label_clerk_re_new_password.place(x=50, y=200)
                self.entry_clerk_re_new_password = Entry(self.register_frame, show='*', font=("times new roman", 15),
                                                         bg="lightgray", width=25)
