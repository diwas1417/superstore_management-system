...
class ClerkSeeProfiles:
    def __init__(self, root):
        ...
        label_heading = Label(self.register_frame, text="You Are Clerk And Your Details:",
        ...
        self.label_clerk_name = Label(self.register_frame, text="Your Name:", font=("times new roman", 15, "bold"),
                                      bg="white", fg="black")
        self.label_clerk_name.place(x=50, y=100)

        self.label_clerk_username = Label(self.register_frame, text="Your UserName:",
                                          font=("times new roman", 15, "bold"), bg="white", fg="black")
        self.label_clerk_username.place(x=50, y=150)

        self.label_clerk_dob = Label(self.register_frame, text="Your DoB:", font=("times new roman", 15, "bold"),
                                     bg="white", fg="black")
        self.label_clerk_dob.place(x=50, y=200)

        self.label_clerk_address = Label(self.register_frame, text="Your Address:",
                                         font=("times new roman", 15, "bold"), bg="white", fg="black")
        self.label_clerk_address.place(x=50, y=250)

        self.label_clerk_phone = Label(self.register_frame, text="Your Phone:", font=("times new roman", 15, "bold"),
                                       bg="white", fg="black")
        self.label_clerk_phone.place(x=50, y=300)

        self.label_clerk_email = Label(self.register_frame, text="Your E-mail:", font=("times new roman", 15, "bold"),
                                       bg="white", fg="black")
