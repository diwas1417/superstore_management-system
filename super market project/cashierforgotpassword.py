...
class CashierForgotPasswordPage:
    def __init__(self, root):
        ...
        back_btn = Button(root, text="<", command=self.back, bg="#021e2f", fg="green",
                          font=("times new roman", 15, "bold"), width=2, )
        back_btn.place(x=0, y=0)

        label_heading = Label(forgot_password_frame, text="Enter Details For Reset Password",
                              font=("times new roman", 20, "bold"), bg="grey", fg="black")
        label_heading.place(x=80, y=10)

        label_cashier_id = Label(forgot_password_frame, text="Cahier Id:", font=("times new roman", 15, "bold"),
                                 bg="white", fg="black")
        ...
        label_cashier_username = Label(forgot_password_frame, text="Cashier UserName:",
                                       font=("times new roman", 15, "bold"), bg="white", fg="black")
        label_cashier_username.place(x=50, y=100)
        self.entry_cashier_username = Entry(forgot_password_frame, font=("times new roman", 15), bg="lightgray",
                                            width=25)
        self.entry_cashier_username.place(x=220, y=100)

        label_cashier_phone = Label(forgot_password_frame, text="Cashier Phone:", font=("times new roman", 15, "bold"),
                                    bg="white", fg="black")
        ...
        label_cashier_dob = Label(forgot_password_frame, text="Cahier E-mail:", font=("times new roman", 15, "bold"),
                                  bg="white", fg="black")
        ...
        label_cashier_new_password = Label(forgot_password_frame, show='*', text="New Password:",
                                           font=("times new roman", 15, "bold"), bg="white", fg="black")
        label_cashier_new_password.place(x=50, y=250)
        self.entry_cashier_new_password = Entry(forgot_password_frame, font=("times new roman", 15), bg="lightgray",
                                                width=25)
        self.entry_cashier_new_password.place(x=220, y=250)

        self.reset_btn = Button(forgot_password_frame, command=self.cashierForgotPassword, text="Reset Password",
