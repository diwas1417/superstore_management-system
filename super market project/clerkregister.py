...
class ClerkRegister:
    def __init__(self, root):
        ...
        label_heading = Label(self.register_frame, text="Enter Details For Clerk Register",
                              font=("times new roman", 20, "bold"), bg="grey", fg="black")
        label_heading.place(x=80, y=10)

        label_clerk_name = Label(self.register_frame, text="Clerk Name:", font=("times new roman", 15, "bold"),
                                 bg="white", fg="black")
        ...
        label_clerk_username = Label(self.register_frame, text="Clerk UserName:", font=("times new roman", 15, "bold"),
                                     bg="white", fg="black")
        ...
        label_clerk_password = Label(self.register_frame, text="Clerk Password:", font=("times new roman", 15, "bold"),
                                     bg="white", fg="black")
        label_clerk_password.place(x=50, y=150)
        self.entry_clerk_password = Entry(self.register_frame, show='*', font=("times new roman", 15), bg="lightgray",
                                          width=25)
        self.entry_clerk_password.place(x=210, y=150)

        label_clerk_dob = Label(self.register_frame, text="Date Of Birth:", font=("times new roman", 15, "bold"),
                                bg="white", fg="black")
        ...
        label_clerk_address = Label(self.register_frame, text="Clerk Address:", font=("times new roman", 15, "bold"),
                                    bg="white", fg="black")
        ...
        label_clerk_phone = Label(self.register_frame, text="Clerk Phone:", font=("times new roman", 15, "bold"),
                                  bg="white", fg="black")
        ...
        label_clerk_email = Label(self.register_frame, text="Clerk E-mail:", font=("times new roman", 15, "bold"),
                                  bg="white", fg="black")
        ...
        self.register_btn = Button(self.register_frame, command=self.clerkRegister, text="Register", bg="white",
                                   fg="green", font=("times new roman", 15, "bold"), width=10, )
    ...
    def clerkRegister(self, *args, **kwargs):
        ...
        if self.name and self.username and self.password and self.dob and self.address and self.phone and self.email != '':
            ...
            c.execute(sql,
                      (self.name, self.username, self.password, self.dob, self.address, self.phone, self.email, date))
            conn.commit()
