...
conn = sqlite3.connect("C:\Users\user\Desktop\git clone repo\Python3-Programming\superStoreSoftware/store.db")
c = conn.cursor()
...
class MainPage:
    def __init__(self, root):
        ...
        title = Label(frame, text="Enter Superstore Details.", font=("times new roman", 30, "bold"), bg="white",
                      fg="green")
        title.place(x=30, y=10)

        self.label_superstore_name = Label(frame, text="Superstore Name:", font=("times new roman", 15, "bold"),
                                           bg="white", fg="black")
        ...
        self.label_superstore_address = Label(frame, text="Superstore Address:", font=("times new roman", 15, "bold"),
                                              bg="white", fg="black")
        ...
        self.cashier_btn = Button(frame, text="Save and Goto Login Page", command=self.gotoMainPage, bg="white",
                                  fg="green", font=("times new roman", 14, "bold"), width=25, )
